...
import * as VFS from 'wa-sqlite/src/VFS.js'; // VENDORADO: import reapontado p/ o pacote (ver header)
...
const DEFAULT_CAPACITY = 3; // VENDORADO: 6 -> 3. iOS Safari limita ~5-6 SyncAccessHandles; 1 conexao rollback-journal usa db+journal (~2). Ver DECISIONS D1.
